...
import { LayoutDashboard, Zap, Gamepad2, Info, ShieldCheck, LogOut, Menu, MessageSquareWarning } from "lucide-react";
...
function GalaxyLogo({ size = 22 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
      <defs>
        ...
        <linearGradient id="gl-arm1" x1="0%" y1="0%" x2="100%" y2="100%">
        ...
        <linearGradient id="gl-arm2" x1="100%" y1="0%" x2="0%" y2="100%">
          <stop offset="0%" stopColor="hsl(315,75%,65%)" stopOpacity="0.7"/>
          <stop offset="100%" stopColor="hsl(271,85%,70%)" stopOpacity="0.3"/>
        </linearGradient>
        <filter id="gl-glow">
      ...
      {/* Outer spiral arm 1 */}
      <path d="M16 16 Q26 6 27 16 Q26 26 16 27 Q6 26 5 16 Q6 6 16 5" stroke="url(#gl-arm1)" strokeWidth="1.8" fill="none" strokeLinecap="round" opacity="0.7"/>
      {/* Inner spiral arm 2 */}
      <path d="M16 16 Q21 11 22 16 Q21 21 16 22 Q11 21 10 16 Q11 11 16 10" stroke="url(#gl-arm2)" strokeWidth="1.2" fill="none" strokeLinecap="round" opacity="0.6"/>
      {/* Core glow */}
      <circle cx="16" cy="16" r="4.5" fill="url(#gl-core)" filter="url(#gl-glow)" opacity="0.9"/>
      ...
      <circle cx="6" cy="28" r="0.5" fill="white" opacity="0.6"/>
      <circle cx="1" cy="15" r="0.6" fill="white" opacity="0.5"/>
      <circle cx="31" cy="16" r="0.7" fill="hsl(271,85%,85%)" opacity="0.65"/>
    </svg>
  );
}
...
export function Layout({ children }: LayoutProps) {
  ...
  return (
    <div className="min-h-screen flex bg-background text-foreground">
      ...
      >
        {/* Nebula glow top-right of sidebar */}
        ...
        <div className="flex items-center gap-3 px-5 py-5 border-b border-sidebar-border relative">
          ...
          <div>
            <div className="text-sm font-black tracking-tight text-galaxy">COZY XO</div>
        ...
        {user && (
          <div className="px-4 py-3.5 border-b border-sidebar-border">
            <div className="rounded-xl p-3" style={{
              background: "linear-gradient(135deg, rgba(139,92,246,0.10) 0%, rgba(59,130,246,0.07) 100%)",
      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        <header className="flex items-center justify-between px-4 py-3 border-b border-border lg:hidden"
          ...
          <div className="flex items-center gap-2.5">
            <GalaxyLogo size={18} />
            <span className="font-black text-sm tracking-tight text-galaxy">COZY XO.SHOP</span>
          </div>
          <button
